...
static int check_overflow(int result, int digit, int sign_of_num)
{
    int max = 2147483647;
    int min = -2147483648;
...
static int check_whitespaces(int index, char const *str)
{
    while (str[index] == ' ') {
        index++;
    }
...
static int check_sign_of_num(int index, int *sign_of_num, char const *str)
{
